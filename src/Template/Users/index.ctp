...
<div class="users index large-9 medium-8 columns content">
    ...
    <?= $this->Form->control('Buscar', ['label' => false, 'placeholder' => 'Buscar Usuario', 'autocompelte' => false, 'id' => 'buscar']); ?>
    <div class="ml-2"><?= $this->Form->control(' Solo Activos ', ['type' => 'checkbox', 'checked' => true, 'id' => 'activo', 'class'=> 'mt-2']); ?></div>
